  ...
  return (
    <div className="relative bg-gray-200 overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto">
        <h3 className="text-md text-center mt-6 mb-8">02806 Social data analysis and visualization</h3>
        ...
        <h4 className="text-lg md:text-2xl text-center mb-8 m-auto w-10/12">
          Organizers, speakers, and attendees need to all work together to make
          events more inclusive.
        </h4>
        <div className="border-gray-400 border-t-2 border-b-2 py-4 px-6 mb-8">
          {/* <div className="flex"><img src="https://pbs.twimg.com/profile_images/1206618382713401345/jErU_sUR_400x400.jpg" className="rounded-full w-full	" /><p>Pietro Rampazzo</p></div> */}
        ...
        <main className="font-serif">
          ...
          <p>
            ...
            torquent per conubia nostra, per inceptos himenaeos. Sed a facilisis
            urna. Praesent porta dui id mi hendrerit, a posuere orci congue.
          </p>
          <p>
