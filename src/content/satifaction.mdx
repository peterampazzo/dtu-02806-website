...
Which might indicate a relation between life satisfaction and the bordeom experienced. 
Furthermore, _Sarrià-Sant Gervasi_ is the district with the highest ratio of kids "very" satisfied. 
Indicating the beforementioned connection with income. 

To investigate the relation with the income, we can evaluate the results for the neighbourhoods groups in variable `'ERFDbllp'`. 
...
By observing the plot we can conclude, that is possible to observe a decrease of the "very statisfied ratio" with the decrease of income. 
However, it is important to keep in mind that the neighbourhoods with the highest income have a lower representation.

To finalize the assesment of the income it is possible to observe the results of the question "How often are you concerned about the money your family has?". 


** MORE PLOTS **


The same pattern is observed, the kids with a higher concern regarding money show the lowest ratio on life satisfaction. 
...
The main conclusion is that there is not a significant difference between genders. 
