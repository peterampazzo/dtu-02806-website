...
<h1 className="text-lg italic text-center">Ratio of “No” access to materials</h1>
<div className="max-w-lg mx-auto">
  <img src="../images/dc_bam-ff.png" width="100%" />
</div>
...
<h1 className="text-lg italic text-center">Ratio of “Yes” on people who live in the household</h1>
<div className="max-w-lg mx-auto">
  <img src="../images/dc_fam-ff.png" width="100%" />
</div>
